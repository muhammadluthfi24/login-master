...
<?php 
	...
	if(isset($_POST['btnSimpan']))
	{
		...
		$simpan = mysqli_query($konek, "insert into karyawan(nokartu, nama, alamat, hobi)values('$nokartu', '$nama', '$alamat', '$hobi')");
...
<body>
	...
	<div class="container-fluid">
		...
		<form method="POST">
			...
			<div class="form-group">
				<label>Hobi</label>
				<textarea class="form-control" name="hobi" id="hobi" placeholder="hobi" style="width: 400px"></textarea>
			</div>
